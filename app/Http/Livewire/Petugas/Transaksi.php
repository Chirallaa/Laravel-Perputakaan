...
class Transaksi extends Component
{
    ...
    public $belum_dipinjam, $sedang_dipinjam, $selesai_dipinjam, $search, $show, $kode_pinjam;
    public $peminjam_id, $denda, $tanggal_kembali, $tanggal_pinjam;
        ...
        public function show(Peminjaman $peminjaman)
    {
        $this->format();
        $this->show = true;
        $this->peminjam_id = $peminjaman->peminjam_id;
        $this->tanggal_pinjam = $peminjaman->tanggal_pinjam;
        $this->tanngal_kembali = $peminjaman->tanggal_kembali;
        $this->denda = $peminjaman->denda;
    }

    public function delete($kode_pinjam) {
        $peminjam = Peminjaman::findOrFail($kode_pinjam);
        $peminjam -> delete();
    session()->flash('sukses', 'Data berhasil dihapus.');
    $this->format();

    return $peminjam->delete();
}
